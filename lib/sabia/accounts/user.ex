defmodule Sabia.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_username(changeset, opts) do
    ...
    |> validate_format(:username, ~r/^\w+$/,
      message: "must have only letters, numbers, and underscores"
    )
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Sabia.Repo)
  ...
  defp maybe_validate_unique_username(changeset, opts) do
    if Keyword.get(opts, :validate_username, true) do
      changeset
      |> unsafe_validate_unique(:username, Sabia.Repo)
  ...
  """
  def valid_password?(%Sabia.Accounts.User{hashed_password: hashed_password}, password)
